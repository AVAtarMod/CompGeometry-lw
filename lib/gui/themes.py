...
def create_theme_white_default() -> Union[str, int]:
   with dpg.theme() as id:
      with dpg.theme_component(0):
         ...
         dpg.add_theme_color(dpg.mvPlotCol_PlotBorder, (0.43 * 255, 0.43 *
                             255, 0.50 * 255, 0.50 * 255), category=dpg.mvThemeCat_Plots)
         ...
         dpg.add_theme_color(dpg.mvPlotCol_XAxisGrid, (0.00 * 255, 0.00 *
                             255, 0.00 * 255, 0.50 * 255), category=dpg.mvThemeCat_Plots)
         dpg.add_theme_color(dpg.mvPlotCol_YAxis         , (0.00 * 255, 0.00 * 255, 0.00 * 255, 1.00 * 255), category=dpg.mvThemeCat_Plots)
         dpg.add_theme_color(dpg.mvPlotCol_YAxisGrid, (0.00 * 255, 0.00 *
                             255, 0.00 * 255, 0.50 * 255), category=dpg.mvThemeCat_Plots)
