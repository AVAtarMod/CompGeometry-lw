...
void task1()
{
    ...
    else
    {
        ...
        if (Point::isInsideAngle(points[1],
            points[2], points[3], points[0]))
            std::cout << "The point lies inside the angle." << std::endl;
        else std::cout << "The point does not lie inside the angle." << std::endl;
    }
    in.close();
}
...
void task2_1()
{
    ...
    else
    {
        ...
        else std::cout << "The point does not lie inside the polygon." << std::endl;
    }
    in.close();
}
...
void task3()
{
    ...
    else
    {
        ...
        else std::cout << "The polygon is not simple." << std::endl;
    }
    in.close();
}
